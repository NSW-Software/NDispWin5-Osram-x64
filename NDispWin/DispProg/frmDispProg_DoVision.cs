...
namespace NDispWin
{
    internal partial class frm_DispCore_DispProg_DoVision : Form
    {
        ...
        private void UpdateDisplay()
        {
            ...
            //{
            //    string s = "Cond1: " + Enum.GetName(typeof(EDispProgCondExec), CmdLine.Index[0]) + " Value " + CmdLine.DPara[0];
            //    lbox_Cond.Items.Add(s);
            //}
            //if (CmdLine.Index[1] > 0)
            //{
            //    string s = "Cond2: " + Enum.GetName(typeof(EDispProgCondExec), CmdLine.Index[1]) + " Value " + CmdLine.DPara[1];
            //    lbox_Cond.Items.Add(s);
            //}
        ...
        private void btn_Grab_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DispProg.frm_CamView.Image = Image.ToBitmap();//Image.ToBitmap();
        ...
        private void tpage_Options_Click(object sender, EventArgs e)
        {
